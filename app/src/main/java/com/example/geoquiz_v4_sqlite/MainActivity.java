...
public class MainActivity extends AppCompatActivity {
    ...
    QuestoesDBHelper mQuestoesRemove;
                ...
                if (cursor != null) {
                    ...
                    try {
                        ...
                        while (!cursor.isAfterLast()) {
                            String texto = cursor.getString(cursor.getColumnIndex(RespostasDbSchema. RespostasTbl.Cols.REPOSTA_APRESENTADA));
                            String texto2 = "";
                            String texto3 = "";
                            ...
                            if(printar == 0)
                            {
                                texto2 = "A capital da Alemanha é Munique \n Resposta: Verdadeiro \n Você marcou: ";
                            }
                            else
                            {
                                texto2 = "O Canal de Suez conecta o Oceano Índico com o Mar Vermelho \n Resposta: Falso \n Você marcou:  " ;
                            }
                            ...
                            printar = (printar +1) % mBancoDeQuestoes.length;
                            Log.i("MSGS", texto);

                            mTextViewQuestoesArmazenadas.append(texto2 + texto + texto3 + "\n");
                            cursor.moveToNext();
                        }
                    } finally {
                        cursor.close();
